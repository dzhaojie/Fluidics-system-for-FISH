...
FlowSensorReader::FlowSensorReader(int measurementPin,
                                   int measurementMaxValue)
    : Thing()
    , mMeasurementPin(measurementPin)
    , mMeasuredValue(0)
...
FlowSensorReader::~FlowSensorReader()
{}



void FlowSensorReader::setValue(uint8_t value)
{}

uint8_t FlowSensorReader::getValue()
{
